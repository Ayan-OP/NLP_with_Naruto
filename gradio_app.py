...
def get_themes(theme_list_str, subtitles_path, save_path):
    ...
    # remove dialouge from the theme list
...
def chat_with_character_chatbot(message, history):
    character_chatbot = CharacterChatBot('AyanOP/Naruto_Llama-3-8B',
                                         huggingface_token=os.getenv('huggingface_token')
                                        )
            ...
            with gr.Column():
                ...
                with gr.Row():
                    ...
                    with gr.Column():
                        ...
                        classify_text_button.click(classify_text, inputs=[text_classification_model_path, text_classification_data_path, text_to_classify], outputs=text_classification_output)
    
    
        # Character Chat Bot Section
        with gr.Row():
            with gr.Column():
