...
class JutsuClassifier():
    def __init__(self,
        ...
        if not huggingface_hub.repo_exists(self.model_path):
            ...
            if data_path is None:
                raise ValueError("Data path is required to train the model, since the model path does not exist in the huggingface hub")
    ...
    def simplify_justsu(self, jutsu):
    ...
    def load_data(self, data_path):
        ...
        df['jutsu_type_simplified'] = df['jutsu_type'].apply(self.simplify_justsu)
